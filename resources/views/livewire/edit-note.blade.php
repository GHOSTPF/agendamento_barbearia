<div>
    <flux:modal name="edit-note" class="md:w-900">
        <div class="space-y-6">
            <div>
                <flux:heading size="lg">Editar Agendamento</flux:heading>
                <flux:text class="mt-2">Edite o agendamento do seu cliente.</flux:text>
            </div>
            ...
            <!-- <flux:checkbox label="Pago" wire:model="paid" /> -->

            <div class="flex">
                <flux:spacer />
                <flux:button type="submit" variant="primary" wire:click="update">Salvar Alterações</flux:button>
            </div>
        </div>
    </flux:modal>
</div>